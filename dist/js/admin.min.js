 ...
 */
function(a){a.offCanvasMenu=function(b,c){var d={menu:a(b),position:"left",menuExpandedClass:"k-show-left-menu",openedClass:"k-is-opened",noTransitionClass:"k-no-transition",wrapper:a(b).parent(),container:a(".container"),menuToggle:[],expandedWidth:a(b).outerWidth(),offCanvasOverlay:"k-off-canvas-overlay",ariaControls:null,opacity:.75},e=this;e.settings={},e.init=function(){function b(){a.each(B,function(){if(void 0==a(this).find("."+e.settings.offCanvasOverlay)[0]){a(this).append('<div class="'+e.settings.offCanvasOverlay+'">');var b=a("."+e.settings.offCanvasOverlay);a.extend(z,b)}})}function f(a){w.bind("keydown",function(b){9===b.keyCode&&u.hasClass(r)&&(b.preventDefault(),b.shiftKey?a.find(":tabbable").last().focus():a.find(":tabbable").first().focus())}),a.find(":tabbable").first().bind("keydown",function(a){9===a.keyCode&&u.hasClass(r)&&a.shiftKey&&(a.preventDefault(),w.focus())}),a.find(":tabbable").last().bind("keydown",function(a){9===a.keyCode&&u.hasClass(r)&&(a.shiftKey||(a.preventDefault(),w.focus()))})}function g(a){clearTimeout(o),b(),w.attr({"aria-expanded":"true"}),u.addClass(r+" "+s+"-"+q),o=setTimeout(function(){f(a)},A)}function h(){clearTimeout(o),console.log(A),w.attr({"aria-expanded":"false"}),u.removeClass(r),o=setTimeout(function(){u.removeClass(s+"-"+q)},A)}function i(a,b){if(u.is('[class*="'+s+'"]')&&!u.is('[class*="'+s+"-"+q+'"]')){var c=u.find('button[class^="k-off-canvas-toggle"]').not(w);c.trigger("click")}b.stopPropagation();var d=u.hasClass(r)?"k-is-opened":"k-is-closed";"k-is-closed"===d&&g(a),"k-is-opened"===d&&h()}function j(){return"left"==q?p.offset().left+y:p.offset().left}function k(a){return"left"==q&&a>=-25&&a<=y||"right"==q&&a>=-y&&a<=25}function l(b){u.hasClass(r)&&(F=!0,D=b.originalEvent.touches[0].pageX,G={startingX:j(),pageX:D,pageY:b.originalEvent.touches[0].pageY},C=u.position().left,H=void 0,E=e.settings.opacity,a.each(B,function(){a(this).addClass(t)}),a.each(z,function(){a(this).addClass(t)}),b.stopPropagation())}function m(b){if(u.hasClass(r)&&(C=b.originalEvent.touches[0].pageX-G.pageX,"undefined"==typeof H&&(H=!!(H||Math.abs(C)<Math.abs(b.originalEvent.touches[0].pageY-G.pageY))),!H)){b.preventDefault();var c="left"==q?G.startingX+C:C-(a(window).width()-G.startingX),d=E/y*Math.abs(c);if(!k(c))return;a.each(B,function(){a(this).hasClass("k-title-bar--mobile")||a(this).css({"-webkit-transform":"translate("+c+"px, 0)","-moz-transform":"translate("+c+"px, 0)","-ms-transform":"translate("+c+"px, 0)","-o-transform":"translate("+c+"px, 0)",transform:"translate("+c+"px, 0)"})}),a.each(z,function(){a(this).css("opacity",d)}),b.stopPropagation()}}function n(b){if(F&&u.hasClass(r)){var c="left"==q?G.startingX+C:C-(a(window).width()-G.startingX),d=Math.abs(c);H||(a.each(B,function(){v.removeAttr("style").removeClass(t),a(".k-js-title-bar").removeAttr("style").removeClass(t)}),a.each(z,function(){a(this).removeAttr("style").removeClass(t)}),"left"==q&&(d<=.66*y||c<=0)||"right"==q&&(d<=.66*y||c>=0)?h():g(p)),F=null,G={},b.stopPropagation()}}e.settings=a.extend({},d,c);var o,p=e.settings.menu,q=e.settings.position,r=e.settings.menuExpandedClass,s=e.settings.openedClass,t=e.settings.noTransitionClass,u=e.settings.wrapper,v=e.settings.container,w=e.settings.menuToggle,x=e.settings.ariaControls,y=p.outerWidth(),z=a("."+e.settings.offCanvasOverlay),A=Math.round(1e3*parseFloat(v.css("transition-duration"))),B=e.settings.transitionElements||e.settings.container;"right"!==q||c.menuExpandedClass||(r="k-show-right-menu"),u.is("body")&&(u=a("html, body")),b(),w.length&&(w.attr({role:"button","aria-controls":x,"aria-expanded":"false"}),w.click(function(a){w.is(":visible")&&i(p,a)}),u.click(function(a){u.hasClass(r)&&(a.stopPropagation(),h())}),p.click(function(a){u.hasClass(r)&&a.stopPropagation()}),a(document).bind("keydown",function(a){27===a.keyCode&&u.hasClass(r)&&(a.stopPropagation(),h(),w.focus())})),"ontouchstart"in document.documentElement&&(u.on("touchstart",l),u.on("touchmove",m),u.on("touchend",n));var C,D,E,F=null,G={},H=!1},e.init()},a.fn.offCanvasMenu=function(b){return this.each(function(){if(void 0==a(this).data("offCanvasMenu")){var c=new a.offCanvasMenu(this,b);a(this).data("offCanvasMenu",c)}})}}(kQuery);var Konami=function(a){var b={addEvent:function(a,b,c,d){a.addEventListener?a.addEventListener(b,c,!1):a.attachEvent&&(a["e"+b+c]=c,a[b+c]=function(){a["e"+b+c](window.event,d)},a.attachEvent("on"+b,a[b+c]))},input:"",pattern:"38384040373937396665",load:function(a){this.addEvent(document,"keydown",function(c,d){if(d&&(b=d),b.input+=c?c.keyCode:event.keyCode,b.input.length>b.pattern.length&&(b.input=b.input.substr(b.input.length-b.pattern.length)),b.input==b.pattern)return b.code(a),b.input="",c.preventDefault(),!1},this),this.iphone.load(a)},code:function(a){window.location=a},iphone:{start_x:0,start_y:0,stop_x:0,stop_y:0,tap:!1,capture:!1,orig_keys:"",keys:["UP","UP","DOWN","DOWN","LEFT","RIGHT","LEFT","RIGHT","TAP","TAP"],code:function(a){b.code(a)},load:function(a){this.orig_keys=this.keys,b.addEvent(document,"touchmove",function(a){if(1==a.touches.length&&1==b.iphone.capture){var c=a.touches[0];b.iphone.stop_x=c.pageX,b.iphone.stop_y=c.pageY,b.iphone.tap=!1,b.iphone.capture=!1,b.iphone.check_direction()}}),b.addEvent(document,"touchend",function(c){1==b.iphone.tap&&b.iphone.check_direction(a)},!1),b.addEvent(document,"touchstart",function(a){b.iphone.start_x=a.changedTouches[0].pageX,b.iphone.start_y=a.changedTouches[0].pageY,b.iphone.tap=!0,b.iphone.capture=!0})},check_direction:function(a){x_magnitude=Math.abs(this.start_x-this.stop_x),y_magnitude=Math.abs(this.start_y-this.stop_y),x=this.start_x-this.stop_x<0?"RIGHT":"LEFT",y=this.start_y-this.stop_y<0?"DOWN":"UP",result=x_magnitude>y_magnitude?x:y,result=1==this.tap?"TAP":result,result==this.keys[0]&&(this.keys=this.keys.slice(1,this.keys.length)),0==this.keys.length&&(this.keys=this.orig_keys,this.code(a))}}};return"string"==typeof a&&b.load(a),"function"==typeof a&&(b.code=a,b.load()),b};!function(a){function b(){function b(b,c){var d=b.attr("data-toggle-button-content")||'<span class="k-toggle-button-bar1"></span><span class="k-toggle-button-bar2"></span><span class="k-toggle-button-bar3"></span>',e='<div class="k-off-canvas-toggle-holder"><button class="k-off-canvas-toggle" type="button">'+d+"</button></div>",f=".k-ui-container",g=b.closest(f),h=g.find(".k-js-title-bar"),i=g.find(".k-js-toolbar"),j=g.find(".k-js-wrapper"),k=g.find(".k-js-content"),l=g.find(".k-js-page"),m=g.find(".k-js-component"),n=g.find(".k-off-canvas-toggle--"+c),o=a(e),p=null,q=l||k;o.addClass("k-off-canvas-toggle-holder--"+c).children("button").addClass("k-off-canvas-toggle--"+c),0===n.length&&("left"==c?h.length?h.prepend(o):i.length&&i.prepend(o):"right"==c&&(i.length?i.append(o):h.length&&h.append(o),q=m),p=a(".k-off-canvas-toggle--"+c),console.log("run",p,j,l,k,q,b),b.offCanvasMenu({menuToggle:p,wrapper:j,container:l||k,position:c,offCanvasOverlay:"k-off-canvas-overlay-"+c,transitionElements:q}))}if(a(".k-js-title-bar, .k-js-toolbar").length&&a(".k-js-wrapper").length&&a(".k-js-content").length){var c=a(".k-js-sidebar-left"),d=a(".k-js-sidebar-right");if(c.length){a.each(c,function(){b(a(this),"left")});var e=a(".k-tree"),f=a(".k-list");(e.length||f.length)&&(e.on("click",".jqtree-title",function(){a(".k-js-wrapper").hasClass("k-is-opened-left")&&a(".k-off-canvas-toggle--left").trigger("click")}),f.on("click","a",function(){a(".k-js-wrapper").hasClass("k-is-opened-left")&&a(".k-off-canvas-toggle--left").trigger("click")}))}d.length&&(a.each(d,function(){b(a(this),"right")}),a(".k-table-container table").on("click","a",function(b){a(this).hasClass("navigate")||b.stopPropagation(),a(this).parents("td").length>0&&a(".k-off-canvas-toggle--right").trigger("click")}))}}var c,d=a(".k-js-responsive-table"),e=a(".k-js-sidebar-toggle-item"),f=a(".k-js-scopebar"),g=a(".k-js-select2"),h=a(".k-js-datepicker"),i=a(".k-js-image-modal"),j=a(".k-js-inline-modal"),k=a(".k-js-iframe-modal"),l=a(".k-js-tooltip"),m=a(".k-js-gallery"),n="k-is-resizing";a(document).ready(function(){function o(b){b.on("click",function(b){a(this).next("ul").length&&(b.preventDefault(),x.hasClass(z)&&a(this).hasClass(A)?r():p(a(this)))})}function p(b){x.hasClass(z)&&a(this).hasClass(A)?r():(a("."+A).removeClass(A),b.addClass(A),x.addClass(z))}function q(){y.on("mouseover",function(b){a(".k-top-container").css("z-index")>=11&&(b.preventDefault(),x.hasClass(z)&&(x.find("."+A).blur(),p(a(this))))})}function r(){x.removeClass(z).find("."+A).removeClass(A)}function s(){if(J.length){var a=P.outerWidth(),b=J.innerWidth(),c=J.scrollLeft();a>b?Q.addClass(K):Q.removeClass(K),a>b&&c>0&&Q.addClass(L),a>b&&Q.addClass(M),(a<=b||c<=0)&&Q.removeClass(L),(a<=b||c>=a-b)&&Q.removeClass(M)}}function t(){var b=a(".k-tabs-scroller-prev"),c=a(".k-tabs-scroller-next");b.on("click",function(){u("prev")}),c.on("click",function(){u("next")})}function u(a){var b,c=P.outerWidth(),d=J.innerWidth(),e=J.scrollLeft();"prev"==a&&(b=e-d*N,b<0&&(b=0)),"next"==a&&(b=e+d*N,b>c-d&&(b=c-d)),J.animate({scrollLeft:b},O)}function v(a){if(a.parent("li").parent("ul").parent().hasClass("k-js-tabs-scroller")){var b,c=a.parent().position().left,d=c+a.parent().outerWidth(),e=parseInt(P.css("padding-left"),10),f=parseInt(P.css("padding-right"),10),g=J.scrollLeft(),h=J.innerWidth();d>g+h&&(b=g+(d-(h+g)+2*f)),c<g&&(b=g-(g-c+2*e)),J.animate({scrollLeft:b},O)}}if(d.length&&d.footable({toggleSelector:".footable-toggle",breakpoints:{phone:400,tablet:600,desktop:800}}),g.length&&g.select2({theme:"bootstrap"}),h.length&&h.kdatepicker(),(i.length||j.length||k.length)&&(i.length&&i.magnificPopup({type:"image"}),j.length&&j.magnificPopup({type:"inline"}),k.length&&k.magnificPopup({type:"iframe"})),l.length&&l.ktooltip({animation:!0,placement:"top",delay:{show:200,hide:50},container:".k-ui-container"}),e.length){var w=a('<div class="k-sidebar-item__toggle"><span class="k-visually-hidden">Toggle</span></div>');e.addClass("k-sidebar-item--toggle").find(".k-sidebar-item__header").append(w),e.on("click",".k-sidebar-item__toggle",function(b){a(this).toggleClass("k-is-active").parent().next().slideToggle(180)})}b();var x=a(".k-js-top-navigation");if(x.length){var y=a(".k-js-top-navigation > ul > li > a"),z="has-open-menu",A="has-open-submenu",B=x.attr("data-toggle-button-content")||"Menu",C='<button type="button" id="k-js-top-navigation-toggle" class="k-top-navigation-toggle" title="Menu toggle" aria-label="Menu toggle">'+B+"</button>";x.parent().append(a(C)),x.offCanvasMenu({menuToggle:a("#k-js-top-navigation-toggle"),position:"right",container:a(".k-wrapper"),expandedWidth:"276",offCanvasOverlay:"k-off-canvas-overlay-top",wrapper:a(".k-ui-container")}),o(y),q(),a(document).mouseup(function(b){var c=a(".k-js-top-navigation > ul");c.is(b.target)||0!==c.has(b.target).length||r()}),a(document).keyup(function(a){27===a.keyCode&&r()})}var D=a(".k-js-subcontent");if(D.length){console.log("yes");var C='<button type="button" class="k-button k-button--default k-subcontent-toggle k-js-subcontent-toggle" title="Subcontent toggle" aria-label="Subcontent toggle"><span class="k-icon-chevron-left" aria-hidden="true"></span></button>';a(".k-content-area .k-js-toolbar").append(kQuery(C)),D.offCanvasMenu({menuToggle:a(".k-js-subcontent-toggle"),position:"right",container:a(".k-content-area__child"),expandedWidth:"276",offCanvasOverlay:"k-off-canvas-overlay-subcontent",wrapper:a(".k-content-area")})}if(f.length&&(a.each(f,function(){var b=a(this),c=b.find(".k-scopebar__item--filters"),d=b.find(".k-scopebar__item--search"),e=".k-scopebar__item--toggle-buttons",f='<div class="k-scopebar__item k-scopebar__item--toggle-buttons"></div>';b.find(e).length||b.prepend(f);var g=b.find(e);c.length&&!b.find(".k-toggle-scopebar-filters").length&&g.prepend('<button type="button" class="k-scopebar__button k-toggle-scopebar-filters k-js-toggle-filters"><span class="k-icon-filter" aria-hidden="true"><span class="k-visually-hidden">Filters toggle</span><div class="k-js-filter-count k-scopebar__item-label k-scopebar__item-label--numberless"></div></button>'),d.length&&!b.find(".k-toggle-scopebar-search").length&&(g.prepend('<button type="button" class="k-scopebar__button k-toggle-scopebar-search k-js-toggle-search"><span class="k-icon-magnifying-glass" aria-hidden="true"><span class="k-visually-hidden">Search toggle</span><div class="k-js-search-count k-scopebar__item-label k-scopebar__item-label--numberless" style="display: none"></div></button>'),g.siblings(".k-scopebar__item--search").find(".k-search__field").val()&&a(".k-js-search-count").show())}),a(".k-js-toggle-filters").on("click",function(){a(this).parent().siblings(".k-scopebar__item--filters").slideToggle("fast")}),a(".k-js-toggle-search").on("click",function(){a(this).parent().siblings(".k-scopebar__item--search").slideToggle("fast")})),m.length){var E,F=240,G=CSS.supports("display","grid"),H=function(){E||(E=setTimeout(function(){E=null,I()},200))},I=function(){var a=parseFloat(m.width()),b=Math.ceil(a/F);m.attr("data-gallery-items",b)};G!==!0&&0!==m.length&&(I(),window.addEventListener("resize",H))}kodekitUI.dragger=function(){function a(a){f=a.clientX,g=parseInt(document.defaultView.getComputedStyle(d).width,10),document.documentElement.addEventListener("mousemove",b,!1),document.documentElement.addEventListener("mouseup",c,!1)}function b(a){document.getElementsByClassName("k-ui-container")[0].classList.add("is-unresponsive"),h=g+a.clientX-f,g+a.clientX-f<=221&&(h=221),d.style.width=h+"px",d.style.minWidth=h+"px",d.style.maxWidth=h+"px"}function c(a){document.documentElement.removeEventListener("mousemove",b,!1),document.documentElement.removeEventListener("mouseup",c,!1),document.getElementsByClassName("k-ui-container")[0].classList.remove("is-unresponsive"),d.removeAttribute("style");var e=g+a.clientX-f;e<=221&&(e=221),createCookie("middlepanewidth",e,30),kodekitUI.setCSS(e),window.dispatchEvent(new Event("resize"))}var d=document.querySelector(".k-js-middlepane");if(null!==d){var e=document.createElement("div");e.className="k-pane-resizer",d.appendChild(e),e.addEventListener("mousedown",a,!1);var f,g,h}},kodekitUI.dragger();var J=a(".k-js-tabs-scroller"),K="k-has-tabs-overflow",L="k-has-tabs-left-overflow",M="k-has-tabs-right-overflow",N=.8,O=400;if(J.length){var P=a(".k-js-tabs"),Q=a(".k-js-tabs-wrapper");Q.prepend('<button type="button" class="k-tabs-scroller-prev"><span class="k-icon-chevron-left"></span><span class="k-visually-hidden">Scroll left</span></button>'),Q.append('<button type="button" class="k-tabs-scroller-next"><span class="k-icon-chevron-right"></span><span class="k-visually-hidden">Scroll right</span></button>'),setTimeout(function(){s(),t(),setTimeout(function(){v(J.find(".k-is-active a"))},O)},500),P.on("click","li a",function(){v(a(this))}),J.on("scroll",function(){clearTimeout(c),c=setTimeout(function(){s()},200)})}new Konami(function(){a("html, .k-ui-container").css({"font-family":"Comic Sans MS","font-size":"20px","line-height":"30px"}).addClass("konami")}),a(window).on("resize",function(){a("body").addClass(n),clearTimeout(c),c=setTimeout(function(){a("body").removeClass(n),s()},200)})}),kodekitUI.loaded=function(){g.length&&a(".k-js-select2").select2({theme:"bootstrap"}),b()}}(kQuery),window.jQuery=globalCacheForjQueryReplacement,globalCacheForjQueryReplacement=void 0;