 ...
 */
function(a){a.offCanvasMenu=function(b,c){var d={menu:a(b),position:"left",menuExpandedClass:"k-show-left-menu",openedClass:"k-is-opened",noTransitionClass:"k-no-transition",wrapper:a(b).parent(),container:a(".container"),menuToggle:[],expandedWidth:a(b).outerWidth(),offCanvasOverlay:"k-off-canvas-overlay",ariaControls:null,opacity:.75},e=this;e.settings={},e.init=function(){function b(){a.each(B,function(){if(void 0==a(this).find("."+e.settings.offCanvasOverlay)[0]){a(this).append('<div class="'+e.settings.offCanvasOverlay+'">');var b=a("."+e.settings.offCanvasOverlay);a.extend(z,b)}})}function f(a){w.bind("keydown",function(b){9===b.keyCode&&u.hasClass(r)&&(b.preventDefault(),b.shiftKey?a.find(":tabbable").last().focus():a.find(":tabbable").first().focus())}),a.find(":tabbable").first().bind("keydown",function(a){9===a.keyCode&&u.hasClass(r)&&a.shiftKey&&(a.preventDefault(),w.focus())}),a.find(":tabbable").last().bind("keydown",function(a){9===a.keyCode&&u.hasClass(r)&&(a.shiftKey||(a.preventDefault(),w.focus()))})}function g(a){clearTimeout(o),b(),w.attr({"aria-expanded":"true"}),u.addClass(r+" "+s),o=setTimeout(function(){f(a)},A)}function h(){clearTimeout(o),w.attr({"aria-expanded":"false"}),u.removeClass(r),o=setTimeout(function(){u.removeClass(s)},A)}function i(a,b){if(u.is('[class*="'+s+'"]')&&!u.is('[class*="'+s+'"]')){var c=u.find('button[class^="k-off-canvas-toggle"]').not(w);c.trigger("click")}b.stopPropagation();var d=u.hasClass(r)?"k-is-opened":"k-is-closed";"k-is-closed"===d&&g(a),"k-is-opened"===d&&h()}function j(){return"left"==q?p.offset().left+y:p.offset().left}function k(a){return"left"==q&&a>=-25&&a<=y||"right"==q&&a>=-y&&a<=25}function l(b){u.hasClass(r)&&(F=!0,D=b.originalEvent.touches[0].pageX,G={startingX:j(),pageX:D,pageY:b.originalEvent.touches[0].pageY},C=u.position().left,H=void 0,E=e.settings.opacity,a.each(B,function(){a(this).addClass(t)}),a.each(z,function(){a(this).addClass(t)}),b.stopPropagation())}function m(b){if(u.hasClass(r)&&(C=b.originalEvent.touches[0].pageX-G.pageX,"undefined"==typeof H&&(H=!!(H||Math.abs(C)<Math.abs(b.originalEvent.touches[0].pageY-G.pageY))),!H)){b.preventDefault();var c="left"==q?G.startingX+C:C-(a(window).width()-G.startingX),d=E/y*Math.abs(c);if(!k(c))return;a.each(B,function(){a(this).hasClass("k-title-bar--mobile")||a(this).css({"-webkit-transform":"translate("+c+"px, 0)","-moz-transform":"translate("+c+"px, 0)","-ms-transform":"translate("+c+"px, 0)","-o-transform":"translate("+c+"px, 0)",transform:"translate("+c+"px, 0)"})}),a.each(z,function(){a(this).css("opacity",d)}),b.stopPropagation()}}function n(b){if(F&&u.hasClass(r)){var c="left"==q?G.startingX+C:C-(a(window).width()-G.startingX),d=Math.abs(c);H||(a.each(B,function(){v.removeAttr("style").removeClass(t),a(".k-js-title-bar").removeAttr("style").removeClass(t)}),a.each(z,function(){a(this).removeAttr("style").removeClass(t)}),"left"==q&&(d<=.66*y||c<=0)||"right"==q&&(d<=.66*y||c>=0)?h():g(p)),F=null,G={},b.stopPropagation()}}e.settings=a.extend({},d,c);var o,p=e.settings.menu,q=e.settings.position,r=e.settings.menuExpandedClass,s=e.settings.openedClass,t=e.settings.noTransitionClass,u=e.settings.wrapper,v=e.settings.container,w=e.settings.menuToggle,x=e.settings.ariaControls,y=p.outerWidth(),z=a("."+e.settings.offCanvasOverlay),A=Math.round(1e3*parseFloat(v.css("transition-duration"))),B=e.settings.transitionElements;"right"!==q||c.menuExpandedClass||(r="k-show-right-menu"),u.is("body")&&(u=a("html, body")),null==e.settings.transitionElements&&(B=v),b(),w.length&&(w.attr({role:"button","aria-controls":x,"aria-expanded":"false"}),w.click(function(a){w.is(":visible")&&i(p,a)}),u.click(function(b){u.hasClass(r)&&b.target==a("."+e.settings.offCanvasOverlay)[0]&&(b.stopPropagation(),h())}),a(document).bind("keydown",function(a){27===a.keyCode&&u.hasClass(r)&&(a.stopPropagation(),h(),w.focus())})),"ontouchstart"in document.documentElement&&(u.on("touchstart",l),u.on("touchmove",m),u.on("touchend",n));var C,D,E,F=null,G={},H=!1},e.init()},a.fn.offCanvasMenu=function(b){return this.each(function(){if(void 0==a(this).data("offCanvasMenu")){var c=new a.offCanvasMenu(this,b);a(this).data("offCanvasMenu",c)}})}}(kQuery),function(a){a(document).ready(function(){kodekitUI.ajaxloading=function(){var b=a(".k-js-ajax-content");b.length&&b.on("click","a",function(b){b.preventDefault(),b.stopPropagation();var c=a(this)[0].href,d=a(this).parent().parent("ul");d.find(".k-is-active").removeClass("k-is-active"),a(this).parent("li").addClass("k-is-active"),a("#k-js-ajax-content").load(c+" #k-js-ajax-content-child",function(b,c,d){"success"==c&&(a(".k-js-wrapper").hasClass("k-show-left-menu")&&a(".k-off-canvas-toggle--left").trigger("click"),kodekitUI.loaded()),"error"==c&&console.log("error")})})}})}(kQuery),function(a){a(document).ready(function(){kodekitUI.dragger=function(){function a(a){f=a.clientX,g=parseInt(document.defaultView.getComputedStyle(d).width,10),document.documentElement.addEventListener("mousemove",b,!1),document.documentElement.addEventListener("mouseup",c,!1)}function b(a){document.getElementsByClassName("k-ui-container")[0].classList.add("is-unresponsive"),h=g+a.clientX-f,g+a.clientX-f<=221&&(h=221),d.style.width=h+"px",d.style.minWidth=h+"px",d.style.maxWidth=h+"px"}function c(a){document.documentElement.removeEventListener("mousemove",b,!1),document.documentElement.removeEventListener("mouseup",c,!1),document.getElementsByClassName("k-ui-container")[0].classList.remove("is-unresponsive"),d.removeAttribute("style");var e=g+a.clientX-f;e<=221&&(e=221),createCookie("middlepanewidth",e,30),kodekitUI.setCSS(e),window.dispatchEvent(new Event("resize"))}var d=document.querySelector(".k-js-middlepane");if(null!==d){var e=document.createElement("div");e.className="k-pane-resizer",d.appendChild(e),e.addEventListener("mousedown",a,!1);var f,g,h}}})}(kQuery),function(a){a(document).ready(function(){kodekitUI.sidebarToggle=function(){function b(b,c){var d,e=b.attr("data-toggle-button-content")||'<span class="k-toggle-button-bar1"></span><span class="k-toggle-button-bar2"></span><span class="k-toggle-button-bar3"></span>',f='<div class="k-off-canvas-toggle-holder"><button class="k-off-canvas-toggle" type="button">'+e+"</button></div>",g=".k-ui-container",h=b.closest(g),i=h.find(".k-js-title-bar"),j=h.find(".k-js-toolbar"),k=h.find(".k-js-wrapper"),l=h.find(".k-js-content"),m=h.find(".k-js-content-area"),n=(h.find(".k-js-page"),h.find(".k-js-component")),o=h.find(".k-off-canvas-toggle--"+c),p=a(f),q=null;p.addClass("k-off-canvas-toggle-holder--"+c).children("button").addClass("k-off-canvas-toggle--"+c);var r=l;d=l,m.length&&(r=m,d=m),0===o.length&&("left"==c?i.length?i.prepend(p):j.length&&j.prepend(p):"right"==c&&(j.length?j.append(p):i.length&&i.append(p),d=n),q=a(".k-off-canvas-toggle--"+c),q.on("click",function(){a(".k-show-subcontent-area").length&&a(".k-js-subcontent-toggle").trigger("click")}),b.offCanvasMenu({menuToggle:q,openedClass:"k-is-opened-"+c,wrapper:k,container:r,position:c,offCanvasOverlay:"k-off-canvas-overlay-"+c,transitionElements:d}))}if(a(".k-js-title-bar, .k-js-toolbar").length&&a(".k-js-wrapper").length&&a(".k-js-content").length){var c=a(".k-js-sidebar-left"),d=a(".k-js-sidebar-right");if(c.length){a.each(c,function(){b(a(this),"left")});var e=a(".k-tree"),f=a(".k-list");(e.length||f.length)&&(e.on("click",".jqtree-title",function(){a(".k-js-wrapper").hasClass("k-is-opened-left")&&a(".k-off-canvas-toggle--left").trigger("click")}),f.on("click","a",function(){a(".k-js-wrapper").hasClass("k-is-opened-left")&&a(".k-off-canvas-toggle--left").trigger("click")}))}d.length&&(a.each(d,function(){b(a(this),"right")}),a(".k-table-container table").on("click","a",function(b){a(this).hasClass("navigate")||b.stopPropagation(),a(this).closest(".k-content").siblings(".k-subcontent").length||a(this).parents("td").length>0&&a(".k-off-canvas-toggle--right").trigger("click")}),a(".k-table-container table tbody").on("click","tr",function(b){a(this).closest("table").hasClass("k-js-click-to-select")||a(this).closest(".k-content").siblings(".k-subcontent").length||"A"!==b.target.nodeName&&"INPUT"!==b.target.nodeName&&(b.stopPropagation(),a(this).find("a").trigger("click"))}))}}})}(kQuery),function(a){a(document).ready(function(){kodekitUI.subcontentToggle=function(){var b=a(".k-js-subcontent");if(b.length){var c=a(".k-content-area__child"),d=b.attr("data-toggle-button-content")||'<span class="k-icon-chevron-left" aria-hidden="true"></span>';c.append(kQuery('<button type="button" class="k-button k-button--default k-subcontent-toggle k-js-subcontent-toggle" title="Subcontent toggle" aria-label="Subcontent toggle">'+d+"</button>")),b.offCanvasMenu({menuToggle:a(".k-js-subcontent-toggle"),menuExpandedClass:"k-show-subcontent-area",openedClass:"k-is-opened-subcontent",position:"right",container:c,expandedWidth:"276",offCanvasOverlay:"k-off-canvas-overlay-subcontent",wrapper:a(".k-content-area")}),a(".k-table-container table").on("click","a",function(b){if(a(this).parents("td").length>0){var c=a(this)[0].closest(".k-content-area__child"),d=a(c).find(".k-js-subcontent-toggle");setTimeout(function(){d.trigger("click")},32)}}),a(".k-table-container table tbody").on("click","tr",function(b){a(this).closest("table").hasClass("k-js-click-to-select")||"A"!==b.target.nodeName&&"INPUT"!==b.target.nodeName&&(b.stopPropagation(),a(this).find("a").trigger("click"))})}}})}(kQuery),function(a){a(document).ready(function(){function b(b){b.on("click",function(b){a(this).next("ul").length&&(b.preventDefault(),f.hasClass(h)&&a(this).hasClass(i)?e():c(a(this)))})}function c(b){f.hasClass(h)&&a(this).hasClass(i)?e():(a("."+i).removeClass(i),b.addClass(i),f.addClass(h))}function d(){g.on("mouseover",function(b){a(".k-top-container").css("z-index")>=11&&(b.preventDefault(),f.hasClass(h)&&(f.find("."+i).blur(),c(a(this))))})}function e(){f.removeClass(h).find("."+i).removeClass(i)}var f=a(".k-js-top-navigation");if(f.length){var g=a(".k-js-top-navigation > ul > li > a"),h="has-open-menu",i="has-open-submenu",j=f.attr("data-toggle-button-content")||"Menu";f.parent().append(a('<button type="button" id="k-js-top-navigation-toggle" class="k-top-navigation-toggle" title="Menu toggle" aria-label="Menu toggle">'+j+"</button>")),f.offCanvasMenu({menuToggle:a("#k-js-top-navigation-toggle"),menuExpandedClass:"k-show-top-menu",openedClass:"k-is-opened-top",position:"right",container:a(".k-js-wrapper"),expandedWidth:"276",offCanvasOverlay:"k-off-canvas-overlay-top",wrapper:a(".k-ui-container")}),b(g),d(),a(document).mouseup(function(b){var c=a(".k-js-top-navigation > ul");c.is(b.target)||0!==c.has(b.target).length||f.hasClass(h)&&e()}),a(document).keyup(function(a){27===a.keyCode&&e()})}})}(kQuery),function(a){a(document).ready(function(){kodekitUI.tabsScroller=function(){function b(a,b,c){if(a.length){var d=b.outerWidth(),h=a.innerWidth(),i=a.scrollLeft();d>h?c.addClass(e):c.removeClass(e),d>h&&i>0&&c.addClass(f),d>h&&c.addClass(g),(d<=h||i<=0)&&c.removeClass(f),(d<=h||i>=d-h)&&c.removeClass(g)}}var c,d=a(".k-js-tabs-scroller"),e="k-has-tabs-overflow",f="k-has-tabs-left-overflow",g="k-has-tabs-right-overflow",h=.8,i=400;d.length&&a.each(d,function(d,e){function f(){n=m.children(".k-tabs-scroller-prev"),o=m.children(".k-tabs-scroller-next"),n.on("click",function(){g("prev")}),o.on("click",function(){g("next")})}function g(a){var b,c=l.outerWidth(),d=k.innerWidth(),e=k.scrollLeft();"prev"==a&&(b=e-d*h,b<0&&(b=0)),"next"==a&&(b=e+d*h,b>c-d&&(b=c-d)),k.animate({scrollLeft:b},i)}function j(a){if(a.parent("li").parent("ul").parent().hasClass("k-js-tabs-scroller")){var b,c=a.parent().position().left,d=c+a.parent().outerWidth(),e=parseInt(l.css("padding-left"),10),f=parseInt(l.css("padding-right"),10),g=k.scrollLeft(),h=k.innerWidth();d>g+h&&(b=g+(d-(h+g)+2*f)),c<g&&(b=g-(g-c+2*e)),k.animate({scrollLeft:b},i)}}var k=a(e),l=k.find(".k-js-tabs"),m=k.parent(".k-js-tabs-wrapper"),n=m.children(".k-tabs-scroller-prev"),o=m.children(".k-tabs-scroller-next");n.length||m.prepend('<button type="button" class="k-tabs-scroller-prev"><span class="k-icon-chevron-left"></span><span class="k-visually-hidden">Scroll left</span></button>'),o.length||m.append('<button type="button" class="k-tabs-scroller-next"><span class="k-icon-chevron-right"></span><span class="k-visually-hidden">Scroll right</span></button>'),setTimeout(function(){b(k,l,m),f(),setTimeout(function(){j(k.find(".k-is-active a"))},i)},500),l.on("click","li a",function(){j(a(this))}),k.on("scroll",function(){clearTimeout(c),c=setTimeout(function(){b(k,l,m)},200)})})}})}(kQuery),function(a){a(document).ready(function(){var b,c=a(".k-js-responsive-table"),d=a(".k-js-sidebar-toggle-item"),e=a(".k-js-scopebar"),f=a(".k-js-select2"),g=a(".k-js-datepicker"),h=a(".k-js-image-modal"),i=a(".k-js-inline-modal"),j=a(".k-js-iframe-modal"),k=a(".k-js-tooltip"),l=a(".k-js-gallery"),m="k-is-resizing";if(c.length&&c.footable({toggleSelector:".footable-toggle",breakpoints:{phone:400,tablet:600,desktop:800}}),f.length&&f.select2({theme:"bootstrap"}),g.length&&g.kdatepicker(),(h.length||i.length||j.length)&&(h.length&&h.magnificPopup({type:"image"}),i.length&&i.magnificPopup({type:"inline"}),j.length&&j.magnificPopup({type:"iframe"})),k.length&&k.ktooltip({animation:!0,placement:"top",delay:{show:200,hide:50},container:".k-ui-container"}),d.length){var n=a('<div class="k-sidebar-item__toggle"><span class="k-visually-hidden">Toggle</span></div>');d.addClass("k-sidebar-item--toggle").find(".k-sidebar-item__header").append(n),d.on("click",".k-sidebar-item__toggle",function(b){a(this).toggleClass("k-is-active").parent().next().slideToggle(180)})}if(e.length&&(a.each(e,function(){var b=a(this),c=b.find(".k-scopebar__item--filters"),d=b.find(".k-scopebar__item--search"),e=".k-scopebar__item--toggle-buttons",f='<div class="k-scopebar__item k-scopebar__item--toggle-buttons"></div>';b.find(e).length||b.prepend(f);var g=b.find(e);c.length&&!b.find(".k-toggle-scopebar-filters").length&&g.prepend('<button type="button" class="k-scopebar__button k-toggle-scopebar-filters k-js-toggle-filters"><span class="k-icon-filter" aria-hidden="true"><span class="k-visually-hidden">Filters toggle</span><div class="k-js-filter-count k-scopebar__item-label k-scopebar__item-label--numberless"></div></button>'),d.length&&!b.find(".k-toggle-scopebar-search").length&&(g.prepend('<button type="button" class="k-scopebar__button k-toggle-scopebar-search k-js-toggle-search"><span class="k-icon-magnifying-glass" aria-hidden="true"><span class="k-visually-hidden">Search toggle</span><div class="k-js-search-count k-scopebar__item-label k-scopebar__item-label--numberless" style="display: none"></div></button>'),g.siblings(".k-scopebar__item--search").find(".k-search__field").val()&&a(".k-js-search-count").show())}),a(".k-js-toggle-filters").on("click",function(){a(this).parent().siblings(".k-scopebar__item--filters").slideToggle("fast")}),a(".k-js-toggle-search").on("click",function(){a(this).parent().siblings(".k-scopebar__item--search").slideToggle("fast")})),l.length){var o,p=240,q=CSS.supports("display","grid"),r=function(){o||(o=setTimeout(function(){o=null,s()},200))},s=function(){var a=parseFloat(l.width()),b=Math.ceil(a/p);l.attr("data-gallery-items",b)};q!==!0&&0!==l.length&&(s(),window.addEventListener("resize",r))}kodekitUI.tabsScroller(),kodekitUI.sidebarToggle(),kodekitUI.subcontentToggle(),kodekitUI.dragger(),kodekitUI.ajaxloading(),new Konami(function(){a("html, .k-ui-container").css({"font-family":"Comic Sans MS"})}),a(window).on("resize",function(){a("body").addClass(m),clearTimeout(b),b=setTimeout(function(){a("body").removeClass(m),kodekitUI.tabsScroller()},200)}),kodekitUI.loaded=function(){f.length&&a(".k-js-select2").select2({theme:"bootstrap"}),kodekitUI.sidebarToggle(),kodekitUI.tabsScroller(),kodekitUI.sidebarToggle(),kodekitUI.dragger(),kodekitUI.subcontentToggle()}})}(kQuery),window.jQuery=globalCacheForjQueryReplacement,globalCacheForjQueryReplacement=void 0;