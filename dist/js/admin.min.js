 ...
 */
function(a){a.offCanvasMenu=function(b,c){var d={menu:a(b),position:"left",menuExpandedClass:"k-show-left-menu",openedClass:"k-is-opened",noTransitionClass:"k-no-transition",wrapper:a(b).parent(),container:a(".container"),menuToggle:[],expandedWidth:a(b).outerWidth(),offCanvasOverlay:"k-off-canvas-overlay",ariaControls:null,opacity:.75},e=this;e.settings={},e.init=function(){function b(){a.each(B,function(){if(void 0==a(this).find("."+e.settings.offCanvasOverlay)[0]){a(this).append('<div class="'+e.settings.offCanvasOverlay+'">');var b=a("."+e.settings.offCanvasOverlay);a.extend(z,b)}})}function f(a){w.bind("keydown",function(b){9===b.keyCode&&u.hasClass(r)&&(b.preventDefault(),b.shiftKey?a.find(":tabbable").last().focus():a.find(":tabbable").first().focus())}),a.find(":tabbable").first().bind("keydown",function(a){9===a.keyCode&&u.hasClass(r)&&a.shiftKey&&(a.preventDefault(),w.focus())}),a.find(":tabbable").last().bind("keydown",function(a){9===a.keyCode&&u.hasClass(r)&&(a.shiftKey||(a.preventDefault(),w.focus()))})}function g(a){clearTimeout(o),b(),w.attr({"aria-expanded":"true"}),u.addClass(r+" "+s+"-"+q),o=setTimeout(function(){f(a)},A)}function h(){clearTimeout(o),w.attr({"aria-expanded":"false"}),u.removeClass(r),o=setTimeout(function(){u.removeClass(s+"-"+q)},A)}function i(a,b){if(u.is('[class*="'+s+'"]')&&!u.is('[class*="'+s+"-"+q+'"]')){var c=u.find('button[class^="k-off-canvas-toggle"]').not(w);c.trigger("click")}b.stopPropagation();var d=u.hasClass(r)?"k-is-opened":"k-is-closed";"k-is-closed"===d&&g(a),"k-is-opened"===d&&h()}function j(){return"left"==q?p.offset().left+y:p.offset().left}function k(a){return"left"==q&&a>=-25&&a<=y||"right"==q&&a>=-y&&a<=25}function l(b){u.hasClass(r)&&(F=!0,D=b.originalEvent.touches[0].pageX,G={startingX:j(),pageX:D,pageY:b.originalEvent.touches[0].pageY},C=u.position().left,H=void 0,E=e.settings.opacity,a.each(B,function(){a(this).addClass(t)}),a.each(z,function(){a(this).addClass(t)}),b.stopPropagation())}function m(b){if(u.hasClass(r)&&(C=b.originalEvent.touches[0].pageX-G.pageX,"undefined"==typeof H&&(H=!!(H||Math.abs(C)<Math.abs(b.originalEvent.touches[0].pageY-G.pageY))),!H)){b.preventDefault();var c="left"==q?G.startingX+C:C-(a(window).width()-G.startingX),d=E/y*Math.abs(c);if(!k(c))return;a.each(B,function(){a(this).hasClass("k-title-bar--mobile")||a(this).css({"-webkit-transform":"translate("+c+"px, 0)","-moz-transform":"translate("+c+"px, 0)","-ms-transform":"translate("+c+"px, 0)","-o-transform":"translate("+c+"px, 0)",transform:"translate("+c+"px, 0)"})}),a.each(z,function(){a(this).css("opacity",d)}),b.stopPropagation()}}function n(b){if(F&&u.hasClass(r)){var c="left"==q?G.startingX+C:C-(a(window).width()-G.startingX),d=Math.abs(c);H||(a.each(B,function(){v.removeAttr("style").removeClass(t),a(".k-js-title-bar").removeAttr("style").removeClass(t)}),a.each(z,function(){a(this).removeAttr("style").removeClass(t)}),"left"==q&&(d<=.66*y||c<=0)||"right"==q&&(d<=.66*y||c>=0)?h():g(p)),F=null,G={},b.stopPropagation()}}e.settings=a.extend({},d,c);var o,p=e.settings.menu,q=e.settings.position,r=e.settings.menuExpandedClass,s=e.settings.openedClass,t=e.settings.noTransitionClass,u=e.settings.wrapper,v=e.settings.container,w=e.settings.menuToggle,x=e.settings.ariaControls,y=p.outerWidth(),z=a("."+e.settings.offCanvasOverlay),A=Math.round(1e3*parseFloat(v.css("transition-duration"))),B=e.settings.transitionElements||e.settings.container;"right"!==q||c.menuExpandedClass||(r="k-show-right-menu"),u.is("body")&&(u=a("html, body")),b(),w.length&&(w.attr({role:"button","aria-controls":x,"aria-expanded":"false"}),w.click(function(a){w.is(":visible")&&i(p,a)}),u.click(function(a){u.hasClass(r)&&(a.stopPropagation(),h())}),p.click(function(a){u.hasClass(r)&&a.stopPropagation()}),a(document).bind("keydown",function(a){27===a.keyCode&&u.hasClass(r)&&(a.stopPropagation(),h(),w.focus())})),"ontouchstart"in document.documentElement&&(u.on("touchstart",l),u.on("touchmove",m),u.on("touchend",n));var C,D,E,F=null,G={},H=!1},e.init()},a.fn.offCanvasMenu=function(b){return this.each(function(){if(void 0==a(this).data("offCanvasMenu")){var c=new a.offCanvasMenu(this,b);a(this).data("offCanvasMenu",c)}})}}(kQuery);var Konami=function(a){var b={addEvent:function(a,b,c,d){a.addEventListener?a.addEventListener(b,c,!1):a.attachEvent&&(a["e"+b+c]=c,a[b+c]=function(){a["e"+b+c](window.event,d)},a.attachEvent("on"+b,a[b+c]))},input:"",pattern:"38384040373937396665",load:function(a){this.addEvent(document,"keydown",function(c,d){if(d&&(b=d),b.input+=c?c.keyCode:event.keyCode,b.input.length>b.pattern.length&&(b.input=b.input.substr(b.input.length-b.pattern.length)),b.input==b.pattern)return b.code(a),b.input="",c.preventDefault(),!1},this),this.iphone.load(a)},code:function(a){window.location=a},iphone:{start_x:0,start_y:0,stop_x:0,stop_y:0,tap:!1,capture:!1,orig_keys:"",keys:["UP","UP","DOWN","DOWN","LEFT","RIGHT","LEFT","RIGHT","TAP","TAP"],code:function(a){b.code(a)},load:function(a){this.orig_keys=this.keys,b.addEvent(document,"touchmove",function(a){if(1==a.touches.length&&1==b.iphone.capture){var c=a.touches[0];b.iphone.stop_x=c.pageX,b.iphone.stop_y=c.pageY,b.iphone.tap=!1,b.iphone.capture=!1,b.iphone.check_direction()}}),b.addEvent(document,"touchend",function(c){1==b.iphone.tap&&b.iphone.check_direction(a)},!1),b.addEvent(document,"touchstart",function(a){b.iphone.start_x=a.changedTouches[0].pageX,b.iphone.start_y=a.changedTouches[0].pageY,b.iphone.tap=!0,b.iphone.capture=!0})},check_direction:function(a){x_magnitude=Math.abs(this.start_x-this.stop_x),y_magnitude=Math.abs(this.start_y-this.stop_y),x=this.start_x-this.stop_x<0?"RIGHT":"LEFT",y=this.start_y-this.stop_y<0?"DOWN":"UP",result=x_magnitude>y_magnitude?x:y,result=1==this.tap?"TAP":result,result==this.keys[0]&&(this.keys=this.keys.slice(1,this.keys.length)),0==this.keys.length&&(this.keys=this.orig_keys,this.code(a))}}};return"string"==typeof a&&b.load(a),"function"==typeof a&&(b.code=a,b.load()),b};!function(a){a(document).ready(function(){function b(b,c){var d=b.attr("data-toggle-button-content")||'<span class="k-toggle-button-bar1"></span><span class="k-toggle-button-bar2"></span><span class="k-toggle-button-bar3"></span>',e='<div class="k-off-canvas-toggle-holder"><button class="k-off-canvas-toggle" type="button">'+d+"</button></div>",f=".k-ui-container",g=b.closest(f),h=g.find(".k-js-title-bar"),i=g.find(".k-js-toolbar"),j=g.find(".k-js-wrapper"),k=g.find(".k-js-content"),l=g.find(".k-js-page"),m=g.find(".k-js-component"),n=g.find(".k-off-canvas-toggle--"+c),o=a(e),p=null,q=l||k;o.addClass("k-off-canvas-toggle-holder--"+c).children("button").addClass("k-off-canvas-toggle--"+c),0===n.length&&("left"==c?h.length?h.prepend(o):i.length&&i.prepend(o):"right"==c&&(i.length?i.append(o):h.length&&h.append(o),q=m),p=a(".k-off-canvas-toggle--"+c),b.offCanvasMenu({menuToggle:p,wrapper:j,container:l||k,position:c,offCanvasOverlay:"k-off-canvas-overlay-"+c,transitionElements:q}))}function c(b){b.on("click",function(b){a(this).next("ul").length&&(b.preventDefault(),B.hasClass(D)&&a(this).hasClass(E)?f():d(a(this)))})}function d(b){B.hasClass(D)&&a(this).hasClass(E)?f():(a("."+E).removeClass(E),b.addClass(E),B.addClass(D))}function e(){C.on("mouseover",function(b){a(".k-top-container").css("z-index")>=11&&(b.preventDefault(),B.hasClass(D)&&(B.find("."+E).blur(),d(a(this))))})}function f(){B.removeClass(D).find("."+E).removeClass(E)}function g(){if(N.length){var a=T.outerWidth(),b=N.innerWidth(),c=N.scrollLeft();a>b?U.addClass(O):U.removeClass(O),a>b&&c>0&&U.addClass(P),a>b&&U.addClass(Q),(a<=b||c<=0)&&U.removeClass(P),(a<=b||c>=a-b)&&U.removeClass(Q)}}function h(){var b=a(".k-tabs-scroller-prev"),c=a(".k-tabs-scroller-next");b.on("click",function(){i("prev")}),c.on("click",function(){i("next")})}function i(a){var b,c=T.outerWidth(),d=N.innerWidth(),e=N.scrollLeft();"prev"==a&&(b=e-d*R,b<0&&(b=0)),"next"==a&&(b=e+d*R,b>c-d&&(b=c-d)),N.animate({scrollLeft:b},S)}function j(a){if(a.parent("li").parent("ul").parent().hasClass("k-js-tabs-scroller")){var b,c=a.parent().position().left,d=c+a.parent().outerWidth(),e=parseInt(T.css("padding-left"),10),f=parseInt(T.css("padding-right"),10),g=N.scrollLeft(),h=N.innerWidth();d>g+h&&(b=g+(d-(h+g)+2*f)),c<g&&(b=g-(g-c+2*e)),N.animate({scrollLeft:b},S)}}var k,l=a(".k-js-responsive-table"),m=a(".k-js-sidebar-toggle-item"),n=a(".k-js-scopebar"),o=a(".k-js-select2"),p=a(".k-js-datepicker"),q=a(".k-js-image-modal"),r=a(".k-js-inline-modal"),s=a(".k-js-iframe-modal"),t=a(".k-js-tooltip"),u=a(".k-js-gallery"),v="k-is-resizing";if(l.length&&l.footable({toggleSelector:".footable-toggle",breakpoints:{phone:400,tablet:600,desktop:800}}),o.length&&o.select2({theme:"bootstrap"}),p.length&&p.kdatepicker(),(q.length||r.length||s.length)&&(q.length&&q.magnificPopup({type:"image"}),r.length&&r.magnificPopup({type:"inline"}),s.length&&s.magnificPopup({type:"iframe"})),t.length&&t.ktooltip({animation:!0,placement:"top",delay:{show:200,hide:50},container:".k-ui-container"}),m.length){var w=a('<div class="k-sidebar-item__toggle"><span class="k-visually-hidden">Toggle</span></div>');m.addClass("k-sidebar-item--toggle").find(".k-sidebar-item__header").append(w),m.on("click",".k-sidebar-item__toggle",function(b){a(this).toggleClass("k-is-active").parent().next().slideToggle(180)})}if(a(".k-js-title-bar, .k-js-toolbar").length&&a(".k-js-wrapper").length&&a(".k-js-content").length){var x=a(".k-js-sidebar-left"),y=a(".k-js-sidebar-right");if(x.length){a.each(x,function(){b(a(this),"left")});var z=a(".k-tree"),A=a(".k-list");(z.length||A.length)&&(z.on("click",".jqtree-title",function(){a(".k-js-wrapper").hasClass("k-is-opened-left")&&a(".k-off-canvas-toggle--left").trigger("click")}),A.on("click","a",function(){a(".k-js-wrapper").hasClass("k-is-opened-left")&&a(".k-off-canvas-toggle--left").trigger("click")}))}y.length&&(a.each(y,function(){b(a(this),"right")}),a(".k-table-container table").on("click","a",function(b){a(this).hasClass("navigate")||b.stopPropagation(),a(this).parents("td").length>0&&a(".k-off-canvas-toggle--right").trigger("click")}))}var B=a(".k-js-top-navigation");if(B.length){var C=a(".k-js-top-navigation > ul > li > a"),D="has-open-menu",E="has-open-submenu",F=B.attr("data-toggle-button-content")||"Menu",G='<button type="button" id="k-js-top-navigation-toggle" class="k-top-navigation-toggle" title="Menu toggle" aria-label="Menu toggle">'+F+"</button>";B.parent().append(a(G)),B.offCanvasMenu({menuToggle:a("#k-js-top-navigation-toggle"),position:"right",container:a(".k-wrapper"),expandedWidth:"276",offCanvasOverlay:"k-off-canvas-overlay-top",wrapper:a(".k-ui-container")}),c(C),e(),a(document).mouseup(function(b){var c=a(".k-js-top-navigation > ul");c.is(b.target)||0!==c.has(b.target).length||f()}),a(document).keyup(function(a){27===a.keyCode&&f()})}var H=a(".k-js-form");if(H.length){var G='<button type="button" class="k-button k-button--default k-form-toggle k-js-form-toggle" title="Form toggle" aria-label="Form toggle"><span class="k-icon-chevron-left" aria-hidden="true"></span></button>';a(".k-page .k-js-toolbar").append(kQuery(G)),H.offCanvasMenu({menuToggle:a(".k-js-form-toggle"),position:"right",container:a(".k-page-content"),expandedWidth:"276",offCanvasOverlay:"k-off-canvas-overlay-form",wrapper:a(".k-page")})}if(n.length&&(a.each(n,function(){var b=a(this),c=b.find(".k-scopebar__item--filters"),d=b.find(".k-scopebar__item--search"),e=".k-scopebar__item--toggle-buttons",f='<div class="k-scopebar__item k-scopebar__item--toggle-buttons"></div>';b.find(e).length||b.prepend(f);var g=b.find(e);c.length&&!b.find(".k-toggle-scopebar-filters").length&&g.prepend('<button type="button" class="k-scopebar__button k-toggle-scopebar-filters k-js-toggle-filters"><span class="k-icon-filter" aria-hidden="true"><span class="k-visually-hidden">Filters toggle</span><div class="k-js-filter-count k-scopebar__item-label k-scopebar__item-label--numberless"></div></button>'),d.length&&!b.find(".k-toggle-scopebar-search").length&&(g.prepend('<button type="button" class="k-scopebar__button k-toggle-scopebar-search k-js-toggle-search"><span class="k-icon-magnifying-glass" aria-hidden="true"><span class="k-visually-hidden">Search toggle</span><div class="k-js-search-count k-scopebar__item-label k-scopebar__item-label--numberless" style="display: none"></div></button>'),g.siblings(".k-scopebar__item--search").find(".k-search__field").val()&&a(".k-js-search-count").show())}),a(".k-js-toggle-filters").on("click",function(){a(this).parent().siblings(".k-scopebar__item--filters").slideToggle("fast")}),a(".k-js-toggle-search").on("click",function(){a(this).parent().siblings(".k-scopebar__item--search").slideToggle("fast")})),u.length){var I,J=240,K=CSS.supports("display","grid"),L=function(){I||(I=setTimeout(function(){I=null,M()},200))},M=function(){var a=parseFloat(u.width()),b=Math.ceil(a/J);u.attr("data-gallery-items",b)};K!==!0&&0!==u.length&&(M(),window.addEventListener("resize",L))}kodekitUI.dragger=function(){function a(a){f=a.clientX,g=parseInt(document.defaultView.getComputedStyle(d).width,10),document.documentElement.addEventListener("mousemove",b,!1),document.documentElement.addEventListener("mouseup",c,!1)}function b(a){document.body.classList.add("is-unresponsive"),h=g+a.clientX-f,g+a.clientX-f<=221&&(h=221),d.style.width=h+"px",d.style.minWidth=h+"px",d.style.maxWidth=h+"px"}function c(a){document.documentElement.removeEventListener("mousemove",b,!1),document.documentElement.removeEventListener("mouseup",c,!1),document.body.classList.remove("is-unresponsive"),d.removeAttribute("style");var e=g+a.clientX-f;e<=221&&(e=221),createCookie("middlepanewidth",e,30),kodekitUI.setCSS(e),window.dispatchEvent(new Event("resize"))}var d=document.querySelector(".k-js-middlepane");if(null!==d){var e=document.createElement("div");e.className="k-middlepane-resizer",d.appendChild(e),e.addEventListener("mousedown",a,!1);var f,g,h}},kodekitUI.dragger();var N=a(".k-js-tabs-scroller"),O="k-has-tabs-overflow",P="k-has-tabs-left-overflow",Q="k-has-tabs-right-overflow",R=.8,S=400;if(N.length){var T=a(".k-js-tabs"),U=a(".k-js-tabs-wrapper");U.prepend('<button type="button" class="k-tabs-scroller-prev"><span class="k-icon-chevron-left"></span><span class="k-visually-hidden">Scroll left</span></button>'),U.append('<button type="button" class="k-tabs-scroller-next"><span class="k-icon-chevron-right"></span><span class="k-visually-hidden">Scroll right</span></button>'),setTimeout(function(){g(),h(),setTimeout(function(){j(N.find(".k-is-active a"))},S)},500),T.on("click","li a",function(){j(a(this))}),N.on("scroll",function(){clearTimeout(k),k=setTimeout(function(){g()},200)})}new Konami(function(){a("html, .k-ui-container").css({"font-family":"Comic Sans MS","font-size":"20px","line-height":"30px"}).addClass("konami")}),a(window).on("resize",function(){a("body").addClass(v),clearTimeout(k),k=setTimeout(function(){a("body").removeClass(v),g()},200)})})}(kQuery),window.jQuery=globalCacheForjQueryReplacement,globalCacheForjQueryReplacement=void 0;