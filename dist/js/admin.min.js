 ...
 */
function(a){a.offCanvasMenu=function(b,c){var d={menu:a(b),position:"left",menuExpandedClass:"k-show-left-menu",openedClass:"k-is-opened",noTransitionClass:"k-no-transition",wrapper:a(b).parent(),container:a(".container"),menuToggle:[],expandedWidth:a(b).outerWidth(),offCanvasOverlay:"k-off-canvas-overlay",ariaControls:null,opacity:.75},e=this;e.settings={},e.init=function(){function b(a){v.bind("keydown",function(b){9===b.keyCode&&t.hasClass(q)&&(b.preventDefault(),b.shiftKey?a.find(":tabbable").last().focus():a.find(":tabbable").first().focus())}),a.find(":tabbable").first().bind("keydown",function(a){9===a.keyCode&&t.hasClass(q)&&a.shiftKey&&(a.preventDefault(),v.focus())}),a.find(":tabbable").last().bind("keydown",function(a){9===a.keyCode&&t.hasClass(q)&&(a.shiftKey||(a.preventDefault(),v.focus()))})}function f(a){clearTimeout(n),v.attr({"aria-expanded":"true"}),t.addClass(q+" "+r+"-"+p),n=setTimeout(function(){b(a)},z)}function g(){clearTimeout(n),v.attr({"aria-expanded":"false"}),t.removeClass(q),n=setTimeout(function(){t.removeClass(r+"-"+p)},z)}function h(a,b){if(t.is('[class*="'+r+'"]')&&!t.is('[class*="'+r+"-"+p+'"]')){var c=t.find('button[class^="k-off-canvas-toggle"]').not(v);c.trigger("click")}b.stopPropagation();var d=t.hasClass(q)?"k-is-opened":"k-is-closed";"k-is-closed"===d&&f(a),"k-is-opened"===d&&g()}function i(){return"left"==p?o.offset().left+x:o.offset().left}function j(a){return"left"==p&&a>=-25&&a<=x||"right"==p&&a>=-x&&a<=25}function k(b){t.hasClass(q)&&(E=!0,C=b.originalEvent.touches[0].pageX,F={startingX:i(),pageX:C,pageY:b.originalEvent.touches[0].pageY},B=t.position().left,G=void 0,D=e.settings.opacity,a.each(A,function(){a(this).addClass(s)}),a.each(y,function(){a(this).addClass(s)}),b.stopPropagation())}function l(b){if(t.hasClass(q)&&(B=b.originalEvent.touches[0].pageX-F.pageX,"undefined"==typeof G&&(G=!!(G||Math.abs(B)<Math.abs(b.originalEvent.touches[0].pageY-F.pageY))),!G)){b.preventDefault();var c="left"==p?F.startingX+B:B-(a(window).width()-F.startingX),d=D/x*Math.abs(c);if(!j(c))return;a.each(A,function(){a(this).hasClass("k-title-bar--mobile")||a(this).css({"-webkit-transform":"translate("+c+"px, 0)","-moz-transform":"translate("+c+"px, 0)","-ms-transform":"translate("+c+"px, 0)","-o-transform":"translate("+c+"px, 0)",transform:"translate("+c+"px, 0)"})}),a.each(y,function(){a(this).css("opacity",d)}),b.stopPropagation()}}function m(b){if(E&&t.hasClass(q)){var c="left"==p?F.startingX+B:B-(a(window).width()-F.startingX),d=Math.abs(c);G||(a.each(A,function(){u.removeAttr("style").removeClass(s),a(".k-js-title-bar").removeAttr("style").removeClass(s)}),a.each(y,function(){a(this).removeAttr("style").removeClass(s)}),"left"==p&&(d<=.66*x||c<=0)||"right"==p&&(d<=.66*x||c>=0)?g():f(o)),E=null,F={},b.stopPropagation()}}e.settings=a.extend({},d,c);var n,o=e.settings.menu,p=e.settings.position,q=e.settings.menuExpandedClass,r=e.settings.openedClass,s=e.settings.noTransitionClass,t=e.settings.wrapper,u=e.settings.container,v=e.settings.menuToggle,w=e.settings.ariaControls,x=o.outerWidth(),y=a("."+e.settings.offCanvasOverlay),z=Math.round(1e3*parseFloat(u.css("transition-duration"))),A=e.settings.transitionElements||e.settings.container;"right"!==p||c.menuExpandedClass||(q="k-show-right-menu"),t.is("body")&&(t=a("html, body")),a.each(A,function(){if(void 0==a(this).find("."+e.settings.offCanvasOverlay)[0]){a(this).append('<div class="'+e.settings.offCanvasOverlay+'">');var b=a("."+e.settings.offCanvasOverlay);a.extend(y,b)}}),v.length&&(v.attr({role:"button","aria-controls":w,"aria-expanded":"false"}),v.click(function(a){v.is(":visible")&&h(o,a)}),t.click(function(a){t.hasClass(q)&&(a.stopPropagation(),g())}),o.click(function(a){a.stopPropagation()}),a(document).bind("keydown",function(a){27===a.keyCode&&t.hasClass(q)&&(a.stopPropagation(),g(),v.focus())})),"ontouchstart"in document.documentElement&&(t.on("touchstart",k),t.on("touchmove",l),t.on("touchend",m));var B,C,D,E=null,F={},G=!1},e.init()},a.fn.offCanvasMenu=function(b){return this.each(function(){if(void 0==a(this).data("offCanvasMenu")){var c=new a.offCanvasMenu(this,b);a(this).data("offCanvasMenu",c)}})}}(kQuery);var Konami=function(a){var b={addEvent:function(a,b,c,d){a.addEventListener?a.addEventListener(b,c,!1):a.attachEvent&&(a["e"+b+c]=c,a[b+c]=function(){a["e"+b+c](window.event,d)},a.attachEvent("on"+b,a[b+c]))},input:"",pattern:"38384040373937396665",load:function(a){this.addEvent(document,"keydown",function(c,d){if(d&&(b=d),b.input+=c?c.keyCode:event.keyCode,b.input.length>b.pattern.length&&(b.input=b.input.substr(b.input.length-b.pattern.length)),b.input==b.pattern)return b.code(a),b.input="",c.preventDefault(),!1},this),this.iphone.load(a)},code:function(a){window.location=a},iphone:{start_x:0,start_y:0,stop_x:0,stop_y:0,tap:!1,capture:!1,orig_keys:"",keys:["UP","UP","DOWN","DOWN","LEFT","RIGHT","LEFT","RIGHT","TAP","TAP"],code:function(a){b.code(a)},load:function(a){this.orig_keys=this.keys,b.addEvent(document,"touchmove",function(a){if(1==a.touches.length&&1==b.iphone.capture){var c=a.touches[0];b.iphone.stop_x=c.pageX,b.iphone.stop_y=c.pageY,b.iphone.tap=!1,b.iphone.capture=!1,b.iphone.check_direction()}}),b.addEvent(document,"touchend",function(c){1==b.iphone.tap&&b.iphone.check_direction(a)},!1),b.addEvent(document,"touchstart",function(a){b.iphone.start_x=a.changedTouches[0].pageX,b.iphone.start_y=a.changedTouches[0].pageY,b.iphone.tap=!0,b.iphone.capture=!0})},check_direction:function(a){x_magnitude=Math.abs(this.start_x-this.stop_x),y_magnitude=Math.abs(this.start_y-this.stop_y),x=this.start_x-this.stop_x<0?"RIGHT":"LEFT",y=this.start_y-this.stop_y<0?"DOWN":"UP",result=x_magnitude>y_magnitude?x:y,result=1==this.tap?"TAP":result,result==this.keys[0]&&(this.keys=this.keys.slice(1,this.keys.length)),0==this.keys.length&&(this.keys=this.orig_keys,this.code(a))}}};return"string"==typeof a&&b.load(a),"function"==typeof a&&(b.code=a,b.load()),b};!function(a){a(document).ready(function(){function b(b,c){var d=b.attr("data-toggle-button-content")||'<span class="k-toggle-button-bar1"></span><span class="k-toggle-button-bar2"></span><span class="k-toggle-button-bar3"></span>',e='<div class="k-off-canvas-toggle-holder"><button class="k-off-canvas-toggle" type="button">'+d+"</button></div>",f=".k-ui-container",g=b.closest(f),h=g.find(".k-js-title-bar"),i=g.find(".k-js-toolbar"),j=g.find(".k-js-wrapper"),k=g.find(".k-js-content"),l=g.find(".k-js-page"),m=g.find(".k-js-component"),n=g.find(".k-off-canvas-toggle--"+c),o=a(e),p=null,q=l||k;o.addClass("k-off-canvas-toggle-holder--"+c).children("button").addClass("k-off-canvas-toggle--"+c),0===n.length&&("left"==c?h.length?h.prepend(o):i.length&&i.prepend(o):"right"==c&&(i.length?i.append(o):h.length&&h.append(o),q=m),p=a(".k-off-canvas-toggle--"+c),b.offCanvasMenu({menuToggle:p,wrapper:j,container:l||k,position:c,offCanvasOverlay:"k-off-canvas-overlay-"+c,transitionElements:q}))}function c(b){b.on("click",function(b){a(this).next("ul").length&&(b.preventDefault(),E.hasClass(G)&&a(this).hasClass(H)?f():d(a(this)))})}function d(b){E.hasClass(G)&&a(this).hasClass(H)?f():(a("."+H).removeClass(H),b.addClass(H),E.addClass(G))}function e(){F.on("mouseover",function(b){a(".k-top-container").css("z-index")>=11&&(b.preventDefault(),E.hasClass(G)&&(E.find("."+H).blur(),d(a(this))))})}function f(){E.removeClass(G).find("."+H).removeClass(H)}function g(a){S=a.clientX,T=parseInt(document.defaultView.getComputedStyle(Q).width,10),document.documentElement.addEventListener("mousemove",h,!1),document.documentElement.addEventListener("mouseup",i,!1)}function h(a){document.body.classList.add("is-unresponsive"),U=T+a.clientX-S,T+a.clientX-S<=221&&(U=221),Q.style.width=U+"px",Q.style.minWidth=U+"px",Q.style.maxWidth=U+"px"}function i(a){document.documentElement.removeEventListener("mousemove",h,!1),document.documentElement.removeEventListener("mouseup",i,!1),document.body.classList.remove("is-unresponsive"),Q.removeAttribute("style");var b=T+a.clientX-S;b<=221&&(b=221),createCookie("middlepanewidth",b,30),kuiMiddlepane.setCSS(b),window.dispatchEvent(new Event("resize"))}function j(){if(V.length){var a=_.outerWidth(),b=V.innerWidth(),c=V.scrollLeft();a>b?aa.addClass(W):aa.removeClass(W),a>b&&c>0&&aa.addClass(X),a>b&&aa.addClass(Y),(a<=b||c<=0)&&aa.removeClass(X),(a<=b||c>=a-b)&&aa.removeClass(Y)}}function k(){var b=a(".k-tabs-scroller-prev"),c=a(".k-tabs-scroller-next");b.on("click",function(){l("prev")}),c.on("click",function(){l("next")})}function l(a){var b,c=_.outerWidth(),d=V.innerWidth(),e=V.scrollLeft();"prev"==a&&(b=e-d*Z,b<0&&(b=0)),"next"==a&&(b=e+d*Z,b>c-d&&(b=c-d)),V.animate({scrollLeft:b},$)}function m(a){if(a.parent("li").parent("ul").parent().hasClass("k-js-tabs-scroller")){var b,c=a.parent().position().left,d=c+a.parent().outerWidth(),e=parseInt(_.css("padding-left"),10),f=parseInt(_.css("padding-right"),10),g=V.scrollLeft(),h=V.innerWidth();d>g+h&&(b=g+(d-(h+g)+2*f)),c<g&&(b=g-(g-c+2*e)),V.animate({scrollLeft:b},$)}}var n,o=a(".k-js-responsive-table"),p=a(".k-js-sidebar-toggle-item"),q=a(".k-js-scopebar"),r=a(".k-js-select2"),s=a(".k-js-datepicker"),t=a(".k-js-image-modal"),u=a(".k-js-inline-modal"),v=a(".k-js-iframe-modal"),w=a(".k-js-tooltip"),x=a(".k-js-gallery"),y="k-is-resizing";if(o.length&&o.footable({toggleSelector:".footable-toggle",breakpoints:{phone:400,tablet:600,desktop:800}}),r.length&&r.select2({theme:"bootstrap"}),s.length&&s.kdatepicker(),(t.length||u.length||v.length)&&(t.length&&t.magnificPopup({type:"image"}),u.length&&u.magnificPopup({type:"inline"}),v.length&&v.magnificPopup({type:"iframe"})),w.length&&w.ktooltip({animation:!0,placement:"top",delay:{show:200,hide:50},container:".k-ui-container"}),p.length){var z=a('<div class="k-sidebar-item__toggle"><span class="k-visually-hidden">Toggle</span></div>');p.addClass("k-sidebar-item--toggle").find(".k-sidebar-item__header").append(z),p.on("click",".k-sidebar-item__toggle",function(b){a(this).toggleClass("k-is-active").parent().next().slideToggle(180)})}if(a(".k-js-title-bar, .k-js-toolbar").length&&a(".k-js-wrapper").length&&a(".k-js-content").length){var A=a(".k-js-sidebar-left"),B=a(".k-js-sidebar-right");if(A.length){a.each(A,function(){b(a(this),"left")});var C=a(".k-tree"),D=a(".k-list");(C.length||D.length)&&(C.on("click",".jqtree-title",function(){a(".k-js-wrapper").hasClass("k-is-opened-left")&&a(".k-off-canvas-toggle--left").trigger("click")}),D.on("click","a",function(){a(".k-js-wrapper").hasClass("k-is-opened-left")&&a(".k-off-canvas-toggle--left").trigger("click")}))}B.length&&(a.each(B,function(){b(a(this),"right")}),a(".k-table-container table").on("click","a",function(b){a(this).hasClass("navigate")||b.stopPropagation(),a(this).parents("td").length>0&&a(".k-off-canvas-toggle--right").trigger("click")}))}var E=a(".k-js-top-navigation");if(E.length){var F=a(".k-js-top-navigation > ul > li > a"),G="has-open-menu",H="has-open-submenu",I=E.attr("data-toggle-button-content")||"Menu",J='<button type="button" id="k-js-top-navigation-toggle" class="k-top-navigation-toggle" title="Menu toggle" aria-label="Menu toggle">'+I+"</button>";E.parent().append(a(J)),E.offCanvasMenu({menuToggle:a("#k-js-top-navigation-toggle"),position:"right",container:a(".k-wrapper"),expandedWidth:"276",offCanvasOverlay:"k-off-canvas-overlay-top",wrapper:a(".k-ui-container")}),c(F),e(),a(document).mouseup(function(b){var c=a(".k-js-top-navigation > ul");c.is(b.target)||0!==c.has(b.target).length||f()}),a(document).keyup(function(a){27===a.keyCode&&f()})}var K=a(".k-js-form");if(K.length){var J='<button type="button" class="k-button k-button--default k-form-toggle k-js-form-toggle" title="Form toggle" aria-label="Form toggle"><span class="k-icon-chevron-left" aria-hidden="true"></span></button>';a(".k-page .k-js-toolbar").append(kQuery(J)),K.offCanvasMenu({menuToggle:a(".k-js-form-toggle"),position:"right",container:a(".k-page-content"),expandedWidth:"276",offCanvasOverlay:"k-off-canvas-overlay-form",wrapper:a(".k-page")})}if(q.length&&(a.each(q,function(){var b=a(this),c=b.find(".k-scopebar__item--filters"),d=b.find(".k-scopebar__item--search"),e=".k-scopebar__item--toggle-buttons",f='<div class="k-scopebar__item k-scopebar__item--toggle-buttons"></div>';b.find(e).length||b.prepend(f);var g=b.find(e);c.length&&!b.find(".k-toggle-scopebar-filters").length&&g.prepend('<button type="button" class="k-scopebar__button k-toggle-scopebar-filters k-js-toggle-filters"><span class="k-icon-filter" aria-hidden="true"><span class="k-visually-hidden">Filters toggle</span><div class="k-js-filter-count k-scopebar__item-label k-scopebar__item-label--numberless"></div></button>'),d.length&&!b.find(".k-toggle-scopebar-search").length&&(g.prepend('<button type="button" class="k-scopebar__button k-toggle-scopebar-search k-js-toggle-search"><span class="k-icon-magnifying-glass" aria-hidden="true"><span class="k-visually-hidden">Search toggle</span><div class="k-js-search-count k-scopebar__item-label k-scopebar__item-label--numberless" style="display: none"></div></button>'),g.siblings(".k-scopebar__item--search").find(".k-search__field").val()&&a(".k-js-search-count").show())}),a(".k-js-toggle-filters").on("click",function(){a(this).parent().siblings(".k-scopebar__item--filters").slideToggle("fast")}),a(".k-js-toggle-search").on("click",function(){a(this).parent().siblings(".k-scopebar__item--search").slideToggle("fast")})),x.length){var L,M=240,N=CSS.supports("display","grid"),O=function(){L||(L=setTimeout(function(){L=null,P()},200))},P=function(){var a=parseFloat(x.width()),b=Math.ceil(a/M);x.attr("data-gallery-items",b)};N!==!0&&0!==x.length&&(P(),window.addEventListener("resize",O))}var Q=document.querySelector(".k-js-middlepane"),R=document.createElement("div");R.className="k-middlepane-resizer",Q.appendChild(R),R.addEventListener("mousedown",g,!1);var S,T,U,V=a(".k-js-tabs-scroller"),W="k-has-tabs-overflow",X="k-has-tabs-left-overflow",Y="k-has-tabs-right-overflow",Z=.8,$=400;if(V.length){var _=a(".k-js-tabs"),aa=a(".k-js-tabs-wrapper");aa.prepend('<button type="button" class="k-tabs-scroller-prev"><span class="k-icon-chevron-left"></span><span class="k-visually-hidden">Scroll left</span></button>'),aa.append('<button type="button" class="k-tabs-scroller-next"><span class="k-icon-chevron-right"></span><span class="k-visually-hidden">Scroll right</span></button>'),setTimeout(function(){j(),k(),setTimeout(function(){m(V.find(".k-is-active a"))},$)},500),_.on("click","li a",function(){m(a(this))}),V.on("scroll",function(){clearTimeout(n),n=setTimeout(function(){j()},200)})}new Konami(function(){a("html, .k-ui-container").css({"font-family":"Comic Sans MS","font-size":"20px","line-height":"30px"}).addClass("konami")}),a(window).on("resize",function(){a("body").addClass(y),clearTimeout(n),n=setTimeout(function(){a("body").removeClass(y),j()},200)})})}(kQuery),window.jQuery=globalCacheForjQueryReplacement,globalCacheForjQueryReplacement=void 0;