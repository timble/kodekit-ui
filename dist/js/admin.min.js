 ...
 */
function(a){a.offCanvasMenu=function(b,c){var d={menu:a(b),position:"left",menuExpandedClass:"k-show-left-menu",openedClass:"k-is-opened",noTransitionClass:"k-no-transition",wrapper:a(b).parent(),container:a(".container"),menuToggle:[],expandedWidth:a(b).outerWidth(),offCanvasOverlay:"k-off-canvas-overlay",ariaControls:null,opacity:.75},e=this;e.settings={},e.init=function(){function b(a){v.bind("keydown",function(b){9===b.keyCode&&t.hasClass(q)&&(b.preventDefault(),b.shiftKey?a.find(":tabbable").last().focus():a.find(":tabbable").first().focus())}),a.find(":tabbable").first().bind("keydown",function(a){9===a.keyCode&&t.hasClass(q)&&a.shiftKey&&(a.preventDefault(),v.focus())}),a.find(":tabbable").last().bind("keydown",function(a){9===a.keyCode&&t.hasClass(q)&&(a.shiftKey||(a.preventDefault(),v.focus()))})}function f(a){clearTimeout(n),v.attr({"aria-expanded":"true"}),t.addClass(q+" "+r+"-"+p),n=setTimeout(function(){b(a)},z)}function g(){clearTimeout(n),v.attr({"aria-expanded":"false"}),t.removeClass(q),n=setTimeout(function(){t.removeClass(r+"-"+p)},z)}function h(a,b){if(t.is('[class*="'+r+'"]')&&!t.is('[class*="'+r+"-"+p+'"]')){var c=t.find('button[class^="k-off-canvas-menu-toggle"]').not(v);c.trigger("click")}b.stopPropagation();var d=t.hasClass(q)?"k-is-opened":"k-is-closed";"k-is-closed"===d&&f(a),"k-is-opened"===d&&g()}function i(){return"left"==p?o.offset().left+x:o.offset().left}function j(a){return"left"==p&&a>=-25&&a<=x||"right"==p&&a>=-x&&a<=25}function k(b){t.hasClass(q)&&(E=!0,C=b.originalEvent.touches[0].pageX,F={startingX:i(),pageX:C,pageY:b.originalEvent.touches[0].pageY},B=t.position().left,G=void 0,D=e.settings.opacity,a.each(A,function(){a(this).addClass(s)}),a.each(y,function(){a(this).addClass(s)}),b.stopPropagation())}function l(b){if(t.hasClass(q)&&(B=b.originalEvent.touches[0].pageX-F.pageX,"undefined"==typeof G&&(G=!!(G||Math.abs(B)<Math.abs(b.originalEvent.touches[0].pageY-F.pageY))),!G)){b.preventDefault();var c="left"==p?F.startingX+B:B-(a(window).width()-F.startingX),d=D/x*Math.abs(c);if(!j(c))return;a.each(A,function(){a(this).hasClass("k-title-bar--mobile")||a(this).css({"-webkit-transform":"translate("+c+"px, 0)","-moz-transform":"translate("+c+"px, 0)","-ms-transform":"translate("+c+"px, 0)","-o-transform":"translate("+c+"px, 0)",transform:"translate("+c+"px, 0)"})}),a.each(y,function(){a(this).css("opacity",d)}),b.stopPropagation()}}function m(b){if(E&&t.hasClass(q)){var c="left"==p?F.startingX+B:B-(a(window).width()-F.startingX),d=Math.abs(c);G||(a.each(A,function(){u.removeAttr("style").removeClass(s),a(".k-js-title-bar").removeAttr("style").removeClass(s)}),a.each(y,function(){a(this).removeAttr("style").removeClass(s)}),"left"==p&&(d<=.66*x||c<=0)||"right"==p&&(d<=.66*x||c>=0)?g():f(o)),E=null,F={},b.stopPropagation()}}e.settings=a.extend({},d,c);var n,o=e.settings.menu,p=e.settings.position,q=e.settings.menuExpandedClass,r=e.settings.openedClass,s=e.settings.noTransitionClass,t=e.settings.wrapper,u=e.settings.container,v=e.settings.menuToggle,w=e.settings.ariaControls,x=o.outerWidth(),y=a("."+e.settings.offCanvasOverlay),z=Math.round(1e3*parseFloat(u.css("transition-duration"))),A=e.settings.transitionElements||e.settings.container;"right"!==p||c.menuExpandedClass||(q="k-show-right-menu"),t.is("body")&&(t=a("html, body")),a.each(A,function(){if(void 0==a(this).find("."+e.settings.offCanvasOverlay)[0]){a(this).append('<div class="'+e.settings.offCanvasOverlay+'">');var b=a("."+e.settings.offCanvasOverlay);a.extend(y,b)}}),v.length&&(v.attr({role:"button","aria-controls":w,"aria-expanded":"false"}),v.click(function(a){v.is(":visible")&&h(o,a)}),t.click(function(a){t.hasClass(q)&&(a.stopPropagation(),g())}),o.click(function(a){a.stopPropagation()}),a(document).bind("keydown",function(a){27===a.keyCode&&t.hasClass(q)&&(a.stopPropagation(),g(),v.focus())})),"ontouchstart"in document.documentElement&&(t.on("touchstart",k),t.on("touchmove",l),t.on("touchend",m));var B,C,D,E=null,F={},G=!1},e.init()},a.fn.offCanvasMenu=function(b){return this.each(function(){if(void 0==a(this).data("offCanvasMenu")){var c=new a.offCanvasMenu(this,b);a(this).data("offCanvasMenu",c)}})}}(kQuery);var Konami=function(a){var b={addEvent:function(a,b,c,d){a.addEventListener?a.addEventListener(b,c,!1):a.attachEvent&&(a["e"+b+c]=c,a[b+c]=function(){a["e"+b+c](window.event,d)},a.attachEvent("on"+b,a[b+c]))},input:"",pattern:"38384040373937396665",load:function(a){this.addEvent(document,"keydown",function(c,d){if(d&&(b=d),b.input+=c?c.keyCode:event.keyCode,b.input.length>b.pattern.length&&(b.input=b.input.substr(b.input.length-b.pattern.length)),b.input==b.pattern)return b.code(a),b.input="",c.preventDefault(),!1},this),this.iphone.load(a)},code:function(a){window.location=a},iphone:{start_x:0,start_y:0,stop_x:0,stop_y:0,tap:!1,capture:!1,orig_keys:"",keys:["UP","UP","DOWN","DOWN","LEFT","RIGHT","LEFT","RIGHT","TAP","TAP"],code:function(a){b.code(a)},load:function(a){this.orig_keys=this.keys,b.addEvent(document,"touchmove",function(a){if(1==a.touches.length&&1==b.iphone.capture){var c=a.touches[0];b.iphone.stop_x=c.pageX,b.iphone.stop_y=c.pageY,b.iphone.tap=!1,b.iphone.capture=!1,b.iphone.check_direction()}}),b.addEvent(document,"touchend",function(c){1==b.iphone.tap&&b.iphone.check_direction(a)},!1),b.addEvent(document,"touchstart",function(a){b.iphone.start_x=a.changedTouches[0].pageX,b.iphone.start_y=a.changedTouches[0].pageY,b.iphone.tap=!0,b.iphone.capture=!0})},check_direction:function(a){x_magnitude=Math.abs(this.start_x-this.stop_x),y_magnitude=Math.abs(this.start_y-this.stop_y),x=this.start_x-this.stop_x<0?"RIGHT":"LEFT",y=this.start_y-this.stop_y<0?"DOWN":"UP",result=x_magnitude>y_magnitude?x:y,result=1==this.tap?"TAP":result,result==this.keys[0]&&(this.keys=this.keys.slice(1,this.keys.length)),0==this.keys.length&&(this.keys=this.orig_keys,this.code(a))}}};return"string"==typeof a&&b.load(a),"function"==typeof a&&(b.code=a,b.load()),b};!function(a){a(document).ready(function(){function b(b,c){var d=".k-ui-container",e=b.closest(d),f=e.find(".k-js-title-bar"),g=e.find(".k-js-toolbar"),h=e.find(".k-js-wrapper"),i=e.find(".k-js-content"),j=e.find(".k-js-component"),k=e.find(".k-off-canvas-menu-toggle--"+c),m=a(l),n=null,o=i;m.addClass("k-off-canvas-menu-toggle-holder--"+c).children("button").addClass("k-off-canvas-menu-toggle--"+c),0===k.length&&("left"==c?f.length?f.prepend(m):g.length&&g.prepend(m):"right"==c&&(g.length?g.append(m):f.length&&f.append(m),o=j),n=a(".k-off-canvas-menu-toggle--"+c),b.offCanvasMenu({menuToggle:n,wrapper:h,container:i,position:c,transitionElements:o}))}function c(){var a=x.outerWidth(),b=r.innerWidth(),c=r.scrollLeft();a>b?y.addClass(s):y.removeClass(s),a>b&&c>0&&y.addClass(t),a>b&&y.addClass(u),(a<=b||c<=0)&&y.removeClass(t),(a<=b||c>=a-b)&&y.removeClass(u)}function d(){var b=a(".k-tabs-scroller-prev"),c=a(".k-tabs-scroller-next");b.on("click",function(){e("prev")}),c.on("click",function(){e("next")})}function e(a){var b,c=x.outerWidth(),d=r.innerWidth(),e=r.scrollLeft();"prev"==a&&(b=e-d*v,b<0&&(b=0)),"next"==a&&(b=e+d*v,b>c-d&&(b=c-d)),r.animate({scrollLeft:b},w)}function f(a){if(a.parent("li").parent("ul").parent().hasClass("k-js-tabs-scroller")){var b,c=a.parent().position().left,d=c+a.parent().outerWidth(),e=parseInt(x.css("padding-left"),10),f=parseInt(x.css("padding-right"),10),g=r.scrollLeft(),h=r.innerWidth();d>g+h&&(b=g+(d-(h+g)+2*f)),c<g&&(b=g-(g-c+2*e)),r.animate({scrollLeft:b},w)}}var g,h=a(".k-js-responsive-table"),i=a(".k-js-sidebar-toggle-item"),j=a(".k-js-scopebar"),k="k-is-resizing";if(a(".k-js-title-bar, .k-js-toolbar").length&&a(".k-js-wrapper").length&&a(".k-js-content").length){var l='<div class="k-off-canvas-menu-toggle-holder"><button class="k-off-canvas-menu-toggle" type="button"><span class="k-toggle-button-bar1"></span><span class="k-toggle-button-bar2"></span><span class="k-toggle-button-bar3"></span></button></div>',m=a(".k-js-sidebar-left"),n=a(".k-js-sidebar-right");if(m.length){a.each(m,function(){b(a(this),"left")});var o=a(".k-tree"),p=a(".k-list");(o.length||p.length)&&(o.on("click",".jqtree-title",function(){a(".k-js-wrapper").hasClass("k-is-opened-left")&&a(".k-off-canvas-menu-toggle--left").trigger("click")}),p.on("click","a",function(){a(".k-js-wrapper").hasClass("k-is-opened-left")&&a(".k-off-canvas-menu-toggle--left").trigger("click")}))}n.length&&(a.each(n,function(){b(a(this),"right")}),a(".k-table-container table").on("click","a",function(b){a(this).hasClass("navigate")||b.stopPropagation(),a(this).parents("td").length>0&&a(".k-off-canvas-menu-toggle--right").trigger("click")}))}if(h.footable({toggleSelector:".footable-toggle",breakpoints:{phone:400,tablet:600,desktop:800}}),j.length&&(a.each(j,function(){var b=a(this),c=b.find(".k-scopebar__item--filters"),d=b.find(".k-scopebar__item--search"),e=".k-scopebar__item--toggle-buttons",f='<div class="k-scopebar__item k-scopebar__item--toggle-buttons"></div>';b.find(e).length||b.prepend(f);var g=b.find(e);c.length&&!b.find(".k-toggle-scopebar-filters").length&&g.prepend('<button type="button" class="k-scopebar__button k-toggle-scopebar-filters k-js-toggle-filters"><span class="k-icon-filter" aria-hidden="true"><span class="k-visually-hidden">Filters toggle</span><div class="k-js-filter-count k-scopebar__item-label k-scopebar__item-label--numberless"></div></button>'),d.length&&!b.find(".k-toggle-scopebar-search").length&&(g.prepend('<button type="button" class="k-scopebar__button k-toggle-scopebar-search k-js-toggle-search"><span class="k-icon-magnifying-glass" aria-hidden="true"><span class="k-visually-hidden">Search toggle</span><div class="k-js-search-count k-scopebar__item-label k-scopebar__item-label--numberless" style="display: none"></div></button>'),g.siblings(".k-scopebar__item--search").find(".k-search__field").val()&&a(".k-js-search-count").show())}),a(".k-js-toggle-filters").on("click",function(){a(this).parent().siblings(".k-scopebar__item--filters").slideToggle("fast")}),a(".k-js-toggle-search").on("click",function(){a(this).parent().siblings(".k-scopebar__item--search").slideToggle("fast")})),a(".k-js-select2").select2({theme:"bootstrap"}),a(".k-js-datepicker").kdatepicker(),a(".k-js-image-modal").magnificPopup({type:"image"}),a(".k-js-inline-modal").magnificPopup({type:"inline"}),a(".k-js-iframe-modal").magnificPopup({type:"iframe"}),a(".k-js-tooltip").ktooltip({animation:!0,placement:"top",delay:{show:200,hide:50},container:".k-ui-container"}),i.length){var q=a('<div class="k-sidebar-item__toggle"><span class="k-visually-hidden">Toggle</span></div>');i.addClass("k-sidebar-item--toggle").find(".k-sidebar-item__header").append(q),i.on("click",".k-sidebar-item__toggle",function(b){a(this).toggleClass("k-is-active").parent().next().slideToggle(180)})}new Konami(function(){a("html, .k-ui-container").css({"font-family":"Comic Sans MS","font-size":"20px","line-height":"30px"}).addClass("konami")}),new Koowa.Tree("#k-jqtree",{data:[{label:"Main category",id:4},{label:"Sub category 1",id:5,parent:4},{label:"Sub category 2",id:6,parent:4},{label:"Deeper category",id:7,parent:6},{label:"Sub category 3",id:8,parent:4}]});var r=a(".k-js-tabs-scroller"),s="k-has-tabs-overflow",t="k-has-tabs-left-overflow",u="k-has-tabs-right-overflow",v=.8,w=400;if(r.length){var x=a(".k-js-tabs"),y=a(".k-js-tabs-wrapper");y.prepend('<button type="button" class="k-tabs-scroller-prev"><span class="k-icon-chevron-left"></span><span class="k-visually-hidden">Scroll left</span></button>'),y.append('<button type="button" class="k-tabs-scroller-next"><span class="k-icon-chevron-right"></span><span class="k-visually-hidden">Scroll right</span></button>'),setTimeout(function(){c(),d(),setTimeout(function(){f(r.find(".k-is-active a"))},w)},500),x.on("click","li a",function(){f(a(this))}),r.on("scroll",function(){clearTimeout(g),g=setTimeout(function(){c()},200)})}a(window).on("resize",function(){a("body").addClass(k),clearTimeout(g),g=setTimeout(function(){a("body").removeClass(k),c()},200)})})}(kQuery),window.jQuery=globalCacheForjQueryReplacement,globalCacheForjQueryReplacement=void 0;