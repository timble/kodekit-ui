...
!*/
u.addTest("boxshadow",r("boxShadow","1px 1px",!0)),/*!
{
  "name": "CSS Animations",
...
!*/
u.addTest("flexwrap",r("flexWrap","wrap",!0));var F=t._config.usePrefixes?" -webkit- -moz- -o- -ms- ".split(" "):[];t._prefixes=F;var G=t.testStyles=j;/*!
{
  "name": "Touch Events",
...
!*/
u.addTest("touchevents",function(){var c;if("ontouchstart"in a||a.DocumentTouch&&b instanceof DocumentTouch)c=!0;else{var d=["@media (",F.join("touch-enabled),("),"heartz",")","{#modernizr{top:9px;position:absolute}}"].join("");G(d,function(a){c=9===a.offsetTop})}return c}),e(),f(v),delete t.addTest,delete t.addAsyncTest;for(var H=0;H<u._q.length;H++)u._q[H]();a.Modernizr=u}(window,document);